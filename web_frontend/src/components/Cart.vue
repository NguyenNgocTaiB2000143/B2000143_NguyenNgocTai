         ...
         <table class="table table-bordered table-striped table-sm">
            ...
            <tbody>
               <tr :key="index" v-for="(product, index) in products">
                  ...
                  <td>
                     <img class="product-img" :src="product.imgUrl" alt="https://bizweb.dktcdn.net/100/147/954/articles/nguon-goc-dan-guitar.jpg?v=1596599792720" />
                  </td>
...
export default {
   ...
   methods: {
      ...
      // Gọi API thanh toán hoặc thực hiện các bước thanh toán theo logic của bạn
      // Ví dụ: Hiển thị thông báo thanh toán thành công
      alert(`Thanh toán thành công!\nTổng số tiền: ${totalAmount} đồng`);

      // Sau khi thanh toán, có thể cần làm một số công việc như đặt hàng, cập nhật cơ sở dữ liệu, vv.
      // ...
